...
import { Shield, Database, Bell, Users as UsersIcon, Save } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-end">
        <button
          onClick={handleSave}
          className="px-8 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors inline-flex items-center gap-2 font-medium"
        >
