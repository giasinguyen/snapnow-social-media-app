    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>About SnapNow</Text>
            </View>
            <ScrollView contentContainerStyle={styles.content}>
                <Text style={styles.title}>About SnapNow</Text>
                ...
                <Text style={styles.footer}>Version 1.0.0 — Made with ❤️ by the SnapNow Team</Text>
            </ScrollView>
        </SafeAreaView>
    );
}
