  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">Comments Management</h3>
        <p className="text-gray-600">This feature is coming soon. You'll be able to view, moderate, and delete comments here.</p>
      </div>
    </div>
  );
};
